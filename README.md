...
Made with ❤️ and ☕ by the RaiseHive Team
```
...
لقد قمت ببناء منصة تمويل جماعي كاملة على البلوكشين تتضمن:

### ✅ ما تم إنجازه:

1. **Smart Contracts (Solidity)**
   - Factory contract لإنشاء الحملات
   - Campaign contract للتمويل الجماعي
...
1. تثبيت Dependencies في كل مجلد
2. إعداد ملفات `.env`
...
cd blockchain
npm run deploy:sepolia
# احفظ عنوان الـ Factory Contract
تحديث .env بعنوان العقد
Bash

# في backend/.env و frontend/.env
FACTORY_CONTRACT_ADDRESS=0x... # العنوان من الخطوة السابقة
تشغيل المشروع
Bash
